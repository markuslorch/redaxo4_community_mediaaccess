...
$REX['ADDON']['community']['plugin_mediaaccess']['unsecure_fileext'] = 'jpg,jpeg,gif,png,ico,js,css,swf'; //seperate with coma, without dot
...
$REX['ADDON']['community']['plugin_mediaaccess']['unsecure_fileext'] = explode(',',$REX['ADDON']['community']['plugin_mediaaccess']['unsecure_fileext']);
...
else
{
  ...
  if(count(array_intersect($image_fileext, $REX['ADDON']['community']['plugin_mediaaccess']['unsecure_fileext'])) < count($image_fileext))
  {
